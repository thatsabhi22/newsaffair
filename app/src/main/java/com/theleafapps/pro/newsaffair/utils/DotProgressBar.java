    ...
    private void initializeAttributes(AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                ...
                startColor = a.getInteger(R.styleable.DotProgressBar_startColor, getResources().getColor(R.color.colorPrimary));
                endColor = a.getInteger(R.styleable.DotProgressBar_endColor, getResources().getColor(R.color.colorAccent));
            } finally {
                a.recycle();
            }
            ...
            endColor = getResources().getColor(R.color.colorAccent);
        }
    }
